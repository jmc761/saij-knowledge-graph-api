...
/**
 * Service responsible for managing the Knowledge Graph using Apache Jena TDB2.
 * <p>
 * This service handles the initialization of the dataset, loading of initial RDF data,
 * refactoring of the graph structure to match the application's domain, and providing
 * access to concepts via SPARQL queries.
 * </p>
 */
@Service
public class KnowledgeGraphService {
    ...
    /**
     * Constructs the KnowledgeGraphService with necessary dependencies and configuration.
     *
     ...
     */
    public KnowledgeGraphService(ResourceLoader resourceLoader,
    ...
    private void refactorGraph(Model model) {
        // Property to link with the origin
        ...
        while (it.hasNext()) {
            ...
            if (originalUri != null && originalUri.contains("skosTema=")) {
                ...
                if (id != null) {
                    ...
                    // 2. Map and transform relationships
                    saijResource.listProperties().forEachRemaining(stmt -> {
                        Property p = stmt.getPredicate();
                        RDFNode o = stmt.getObject();

                        // If the object is another SAIJ concept, transform it to our domain
                        if (o.isResource()) {
                        ...
                        // Do not duplicate the rdf:type already set above
    ...
    private String extractIdFromUri(String uri) {
        try {
            ...
            // Simple fallback if the parser fails or the URI is invalid
